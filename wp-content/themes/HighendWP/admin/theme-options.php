...
function hb_system_diagnostic() {
    ...
    $to_ret .= '<p>Below information is useful to diagnose some of the possible reasons to malfunctions, performance issues or any errors.<br/>You can faciliate the process of support by providing below information to our support staff.<br/><br/>You need to reset the Theme Options (Backup Settings > Restore Default) in order to see changes.</p>';
