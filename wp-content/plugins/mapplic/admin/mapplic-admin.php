...
add_action('admin_footer-' . $screen->id, 'footer_scripts');
...
function floors_metabox($post, $param) {
	...
	<ul id="floor-list" class="sortable-list">
		<li class="list-item new-item">
			...
			<div class="list-item-settings">
				...
				<label><?php _e('Name', 'mapplic'); ?><br><input type="text" class="input-text title-input" value="New floor" autocomplete="off"></label>
				<label><?php _e('ID (unique)', 'mapplic'); ?><br><input type="text" class="input-text id-input" value="" autocomplete="off"></label>
				<label><?php _e('Map', 'mapplic'); ?><br>
					<input type="text" class="input-text map-input" value="" autocomplete="off">
					<input type="button" class="button media-button" value="<?php _e('Add Map', 'mapplic'); ?>">
				</label>
				<label><?php _e('Minimap', 'mapplic'); ?><br>
					<input type="text" class="input-text minimap-input" value="" autocomplete="off">
	...
	<?php foreach ($floors as &$floor) : ?>
		...
		<li class="list-item">
			...
			<div class="list-item-settings">
				...
				<label><?php _e('Name', 'mapplic'); ?><br><input type="text" class="input-text title-input" value="<?php echo $floor['title']; ?>" autocomplete="off"></label>
				<label><?php _e('ID (unique)', 'mapplic'); ?><br><input type="text" class="input-text id-input" value="<?php echo $floor['id']; ?>" autocomplete="off"></label>
				...
				<label><?php _e('Map', 'mapplic'); ?><br>
					<input type="text" class="input-text map-input" value="<?php echo $floor['map']; ?>" autocomplete="off">
					<input type="button" class="button media-button" value="<?php _e('Add Map', 'mapplic'); ?>">
				</label>
				<label>Minimap<br>
					<input type="text" class="input-text minimap-input" value="<?php echo $floor['minimap']; ?>" autocomplete="off">
					<input type="button" class="button media-button" value="<?php _e('Add Minimap', 'mapplic'); ?>">
				</label>
...
function categories_metabox($post, $param) {
	...
	<ul id="category-list" class="sortable-list">
		...
		<li class="list-item new-item">
			<div class="list-item-handle">
				...
				<a href="#" class="menu-item-toggle"></span></a>
			</div>
			<div class="list-item-settings">

				<label><?php _e('Name', 'mapplic'); ?><br><input type="text" class="input-text title-input" value="New category" autocomplete="off"></label>
				<label><?php _e('ID (unique)', 'mapplic'); ?><br><input type="text" class="input-text id-input" value="" autocomplete="off"></label>
	...
	<?php foreach ($categories as &$category) : ?>
		<li class="list-item">
			...
			<div class="list-item-settings">
				...
				<label><?php _e('Name', 'mapplic'); ?><br><input type="text" class="input-text title-input" value="<?php echo $category['title']; ?>" autocomplete="off"></label>
				<label<?php _e('ID (unique)', 'mapplic'); ?><br><input type="text" class="input-text id-input" value="<?php echo $category['id']; ?>" autocomplete="off"></label>
...
function settings_metabox($post, $param) {
?>
	<h4><?php _e('Map file dimensions (REQUIRED)', 'mapplic'); ?></h4>
	<label>
		<?php _e('Map Width', 'mapplic'); ?><br>
		<input type="text" id="im-mapwidth" value="<?php echo $param['args']['mapwidth']; ?>" autocomplete="off">
	</label>
	<label>
		<?php _e('Map Height', 'mapplic'); ?><br>
		<input type="text" id="im-mapheight" value="<?php echo $param['args']['mapheight']; ?>" autocomplete="off">
	</label>

	<h4><?php _e('Components', 'mapplic'); ?></h4>
	<label>
		<input type="checkbox" id="im-minimap"<?php echo ($param['args']['minimap'] == 'true') ? 'checked' : ''; ?>> <?php _e('Show Minimap', 'mapplic'); ?>
	</label><br>
	<label>
		<input type="checkbox" id="im-sidebar"<?php echo ($param['args']['sidebar'] == 'true') ? 'checked' : ''; ?>> <?php _e('Show Sidebar', 'mapplic'); ?>
	</label>

	<h4><?php _e('General settings', 'mapplic'); ?></h4>
	<label>
		<?php _e('Zoom Limit', 'mapplic'); ?><br>
		<input type="text" id="im-zoomlimit" value="<?php echo $param['args']['zoomlimit']; ?>" autocomplete="off">
	</label>
<?php
}
